          ...
          >
            <div className="text-left">
              <h1 className="text-[56px] leading-[1.1] tracking-tight text-black mb-6 font-light">
                Start your<br />
                <span className="text-[#156d95]">financial journey</span>
              </h1>
              <p className="text-[17px] leading-relaxed text-[#666] mb-8 font-light max-w-md">
                Join thousands of users who have simplified their expense tracking with Fold AI. Get started in seconds.
              </p>
            ...
            <div className="lg:p-12">
              <div className="text-center mb-8 lg:hidden">
                <h2 className="text-[32px] leading-[1.1] tracking-tight text-black mb-3 font-light">
                  Join <span className="text-[#156d95]">Fold AI</span>
                </h2>
                <p className="text-[15px] text-[#666]">Create your account to get started</p>
              </div>
