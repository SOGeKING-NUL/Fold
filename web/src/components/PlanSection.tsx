...
function shouldShowCheck(included: PlanFeature["included"], level: PlanLevel): boolean {
    ...
    <section className="py-24 bg-background">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="text-[40px] font-normal leading-tight mb-4">Choose Your Plan</h2>
