...
const stats: StatItem[] = [
  ...
  {
    value: "95%+",
    description: "OCR accuracy on\nreceipts",
    delay: 0.2,
  },
  {
    value: "3 Modes",
    description: "Text, Voice & Image\ninput support",
    delay: 0.4,
  },
  {
    value: "Hinglish",
    description: "Native support for\nIndian languages",
    delay: 0.6,
  },
]
      ...
      <div className="mx-auto max-w-7xl px-8 py-24 pt-16">
        <div className="grid grid-cols-12 gap-5 gap-y-16">
          <div className="col-span-12 md:col-span-6 relative z-10">
            <div className="relative h-6 inline-flex items-center font-mono uppercase text-xs text-[#146e96] mb-12 px-2">
              <div className="flex items-center gap-0.5 overflow-hidden">
                <motion.span
                  initial={{ width: 0 }}
                  animate={{ width: "auto" }}
                  transition={{ duration: 0.8, ease: "easeOut" }}
                  className="block whitespace-nowrap overflow-hidden text-[#146e96] relative z-10"
                >
                  Trusted at scale
                </motion.span>
                <motion.span
                  ...
                  className="block w-1.5 h-3 bg-[#146e96] ml-0.5 relative z-10 rounded-sm"
                />
              </div>
            </div>

            <h2 className="text-[40px] font-normal leading-tight tracking-tight text-[#111A4A] mb-6">
              Processing thousands of expenses daily{" "}
              <span className="opacity-40 font-normal text-[40px]">
                with AI-powered extraction and double-entry accounting precision.
              </span>
            </h2>

            <p className="text-lg leading-6 text-[#111A4A] opacity-60 mt-0 mb-6">
              Fold transforms receipts, voice notes, and text into organized financial insights. Upload a UPI screenshot,
              record in Hinglish, or simply type — our AI handles categorization, payment detection, and ledger posting
              automatically.
            </p>
                ...
                <div className="relative w-full h-full">
                  {dataPoints.map((point) => (
                    <motion.div
                      ...
                      className="absolute w-1.5 rounded-[3px] bg-[rgba(22,126,108,0.01)]"
                      style={{
                        left: `${point.left}px`,
                        top: `${point.top}px`,
                        background:
                    ...
                    >
                      <motion.div
                        ...
                        className="absolute -left-px w-2 h-2 bg-[#167E6C] rounded-full"
                        style={{
